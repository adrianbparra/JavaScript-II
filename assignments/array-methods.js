...
// Problem 3
// For every $5 dollar donations there is a entry for a special price. return how many prices per person. Return the name and number of entries
...
entries = runners.map(runner => {
  //calc the entries
  //console.log(runner);
  numOfEnteries = Math.floor(runner.donation/5)
  //console.log(numOfEnteries)

  return {"Name":runner.first_name+" "+runner.last_name, "Number of Entries": numOfEnteries }
  //return runner.first_name + " " + runner.last_name + " has "
  //return the full name and # of entries
})
